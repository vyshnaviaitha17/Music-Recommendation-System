...
st.title("Moosic")
st.write('Music Recommendation System using Facial Emotions. To get reccommended songs, start by allowing mic and camera for this web app.')
...
st.write('Made with ❤ by [Vyshu & Team](https://github.com/khankhushi/Moosic)')
